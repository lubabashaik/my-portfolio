...
const experiences = [
  {
    ...
    description: [
      "Developed responsive and user-friendly interfaces using React, JavaScript, and Tailwind CSS, ensuring smooth performance across all devices.",
      "Built reusable UI components and improved code structure for better maintainability and scalability.",
      "Collaborated with backend teams to integrate REST APIs, manage data flows, and enhance application performance.",
      "Worked with tools like Git, GitHub, and modern build systems to maintain clean workflows and version control."
    ],
    technologies: ["React", "Next.js","JavaScript", "TypeScript",  "FastAPI", "PostgreSQL", "Docker",  "MongoDB", "Tailwind CSS", "AWS"],
  ...
  return (
    <section id="Experience" className="min-h-screen py-16 md:py-20 px-4 sm:px-6 bg-[color:var(--bg-900)] relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          className="absolute top-1/4 left-1/4 w-80 h-80 rounded-full border-2 border-red-900] opacity-12"
          animate={{
            scale: [1, 1.3, 1],
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-[color:var(--muted)] text-base md:text-lg max-w-2xl mx-auto px-4">
            My professional journey and the milestones I have achieved along the way
          </p>
        </motion.div>
